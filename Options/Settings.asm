...
.definelabel BigSuit,				0x30 		; Change this line to the desired fully powered suit (ex: 10 for varia, 20 for gravity, 30 for both)

.definelabel endOFROM,				0x8A00000	; Change this to desired location of end of ROM for freespace ASM
